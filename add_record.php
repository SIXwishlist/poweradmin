 ...
 */
echo "    <h1 class=\"page-header\">" . _('Add record to zone') . " <a href=\"edit.php?id=" . $zone_id . "\"> " . $zone_name . "</a></h1>\n";
...
if ($zone_type == "SLAVE" || $perm_content_edit == "none" || ($perm_content_edit == "own" || $perm_content_edit == "own_as_client") && $user_is_zone_owner == "0") {
    ...
    echo "       <tbody>\n";
    echo "       <tr>\n";
    echo "        <td><input type=\"text\" name=\"name\" class=\"form-control input-sm\" value=\"" . htmlspecialchars($name) . "\">." . $zone_name . "</td>\n";
    echo "        <td>IN ";
    ...
    echo "         </select>\n";
    echo "        </td>\n";
    echo "        <td><input type=\"text\" name=\"content\" class=\"form-control input-sm\" value=\"" . htmlspecialchars($content) . "\"></td>\n";
    echo "        <td><input type=\"text\" name=\"prio\" size=\"5\" class=\"form-control input-sm\" value=\"" . htmlspecialchars($prio) . "\"></td>\n";
    echo "        <td><input type=\"text\" name=\"ttl\" size=\"8\" class=\"form-control input-sm\" value=\"" . htmlspecialchars($ttl) . "\"</td>\n";
    echo "       </tr>\n";
    echo "       </tbody>\n";
    echo "      </table>\n";
    echo "      </div>\n";
