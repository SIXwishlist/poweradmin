...
echo "     <h1 class=\"page-header\">" . _('Delete zones') . "</h1>\n";
...
if ($confirm == '1') {
    ...
    echo "                     <button type=\"submit\" name=\"confirm\" class=\"btn btn-default\">" . _('Yes') . "</button>\n";
    echo "                     <button type=\"button\" class=\"btn btn-default\" OnClick=\"location.href='list_zones.php'\">" . _('No') . "</button>\n";
    echo "     </form>\n";
}
